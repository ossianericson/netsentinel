"""
tabs_diag.py — _DiagTabsMixin: diagnostics, MTR, advanced tools, and event handlers.

Extracted from ui/tabs.py (Sprint 8). Logger tab + retention helpers were extracted
to ui/tabs_logger.py (Sprint 15) via _LoggerTabMixin.
"""
...
class _DiagTabsMixin(_LoggerTabMixin):
