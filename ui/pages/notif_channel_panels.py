...
manageable size.  This module provides:
  ...
  • Module-level helpers:  _fmt_elapsed, _enrich_alert_sublabel,
                           _save_secret, _load_secret, _page_header,
                           _card, _field_row, _lineedit, _severity_combo,
                           _JKNavFilter
  • Constants:  keyring keys, channel/severity colour maps, rule definitions
  • _NotifChannelsMixin:  all card builder methods, log-panel methods, and
                          channel test helpers — inherited by NotificationsPage
...
# ── Mixin — all card builders, log panel, and test helpers ────────────────────
