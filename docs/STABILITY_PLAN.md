...
**Sprint 17 queue:** Any new findings from runtime audit; consider further reduction of `home_widgets.py` (1,316 lines) and `pages/notif_channel_panels.py` (1,643 lines); review `help.py` (1,133 lines) for further extraction.
