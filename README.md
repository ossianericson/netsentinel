...
[![Tests](https://img.shields.io/badge/tests-6085%2B-brightgreen?style=flat-square)](tests/)
...
**6,085+ tests &nbsp;·&nbsp; 9-hour chaos-tested &nbsp;·&nbsp; 100% local &nbsp;·&nbsp; MIT License**
...
**6,085 automated tests** across 460 test files — detection logic, metric storage, version consistency, UI wiring, encoding hygiene, and CodeQL-prevention gates. All tests are offline; no real network traffic or live devices required.
...
- Fixed a crash when toggling "Start NetSentinel automatically" a second time in Settings
- Fixed action buttons in the alert detail drawer (Acknowledge, Snooze, etc.) showing clipped text
- Fixed the Current Devices table on the Inventory Change History page being stuck at a small fixed height — it's now resizable
