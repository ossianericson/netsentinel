...
[![Tests](https://img.shields.io/badge/tests-5543%2B-brightgreen?style=flat-square)](tests/)
...
**5,543+ tests &nbsp;·&nbsp; 9-hour chaos-tested &nbsp;·&nbsp; 100% local &nbsp;·&nbsp; MIT License**
...
**5,543 automated tests** across 415 test files — detection logic, metric storage, version consistency, UI wiring, encoding hygiene, and CodeQL-prevention gates. All tests are offline; no real network traffic or live devices required.
