...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 1000 --chaos mild --seed 1 --mem-limit 1000 --output-dir "%OUT%\monkey_mild"
if errorlevel 1 (
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 3000 --chaos moderate --seed 42 --mem-limit 1200 --output-dir "%OUT%\monkey_moderate"
if errorlevel 1 (
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 6000 --chaos wild --seed 99 --mem-limit 1500 --output-dir "%OUT%\monkey_wild"
if errorlevel 1 (
...
echo   - monkey_mild\    -- 1000 iterations mild chaos   (seed 1)
echo   - monkey_moderate\ -- 3000 iterations moderate chaos  (seed 42)
echo   - monkey_wild\    -- 6000 iterations wild chaos   (seed 99)
