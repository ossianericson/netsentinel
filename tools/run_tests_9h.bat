...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 1000 --chaos mild --seed 1 --mem-limit 1000 ^
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 3000 --chaos moderate --seed 42 --mem-limit 1200 ^
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 6000 --chaos wild --seed 99 --mem-limit 1500 ^
