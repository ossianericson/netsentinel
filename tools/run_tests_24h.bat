...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 3000 --chaos mild --seed 1 --mem-limit 1000 --output-dir "%OUT%\monkey_mild"
if errorlevel 1 (
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 9000 --chaos moderate --seed 42 --mem-limit 1200 --output-dir "%OUT%\monkey_moderate"
if errorlevel 1 (
...
set STEP_START=%time%
python "%~dp0monkey_test.py" --source -n 18000 --chaos wild --seed 99 --mem-limit 1500 --output-dir "%OUT%\monkey_wild"
if errorlevel 1 (
