...
KNOWN_LARGE_UI_FILES: dict[str, int] = {
    ...
    "scan_wiring.py": 1100,  # actual 1081 after Cat2-V4 SNMP interface error handler
    ...
    "pages/home_page.py": 1470,  # Sprint H8: +106 lines; v1.9.98: +tip card + pills hint + first-scan banner
