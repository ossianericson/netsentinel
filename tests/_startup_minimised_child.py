...
# never-shown Dashboard's degenerate geometry on every test-suite run. The
# _seed_*_last_session() helpers below already read/write via settings_path()
# for their own setup -- redirecting it here makes that operate on the
# isolated file too, with no change to what any assertion observes.
